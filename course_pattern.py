...
for line in file: 
	...
	if len(year) > 1:
		...
		if (admission in listAdmission):
			...
			listAdmission[admission] = { 'ingressantes' : { 'M': 0, 'F': 0, 'idade': [] }, 'semevasao' : { 'M': 0, 'F': 0, 'idade': [] }, 'desistente' : { 'M': 0, 'F': 0, 'idade': [] }, 'cancelamento' : { 'M': 0, 'F': 0, 'idade': [] }, 'formado' : { 'M': 0, 'F': 0, 'idade': [] }, 'jubilado 01' : { 'M': 0, 'F': 0, 'idade': [] }, 'jubilado 02' : { 'M': 0, 'F': 0, 'idade': [] }, 'transferido' : { 'M': 0, 'F': 0, 'idade': [] }, 'excluido' : { 'M': 0, 'F': 0, 'idade': [] } };
			listAdmission[admission]['ingressantes'][sexo] = 1;
...
for admission in listAdmission: 
	...
	print "Media idade: %.0f anos" % (sum(listAdmission[admission]['ingressantes']['idade']) / ingressantes);
	...
	if (formado > 0):
		...
		print "Media idade: %.0f anos" % (sum(listAdmission[admission]['formado']['idade']) / formado);
	...
	if (jubilados1 > 0):
		...
		if (jubilados1 > 1):
			print "Media idade: %.0f anos" % (sum(listAdmission[admission]['jubilado 01']['idade']) / jubilados1);
	...
	if (jubilados2 > 0):
		...
		if (jubilados2 > 1):
			print "Media idade: %.0f anos" % (sum(listAdmission[admission]['jubilado 02']['idade']) / jubilados2);
	...
	if (excluido > 0):
		...
		if (excluido > 1):
			print "Media idade: %.0f anos" % (sum(listAdmission[admission]['excluido']['idade']) / excluido);
	...
	if (desistente > 0):
		...
		if (desistente > 1):
			print "Media idade: %.0f anos" % (sum(listAdmission[admission]['desistente']['idade']) / desistente);
	...
	if (transferido > 0):
		...
		if (transferido > 1):
			print "Media idade: %.0f anos" % (sum(listAdmission[admission]['transferido']['idade']) / transferido);
	...
	if (cancelamentos > 0):
		...
		if (cancelamentos > 1):
			print "Media idade: %.0f anos" % (sum(listAdmission[admission]['cancelamento']['idade']) / cancelamentos);
